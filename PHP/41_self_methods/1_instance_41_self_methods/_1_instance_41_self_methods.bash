...
$_main:
     ...
     ; (before optimizer)
     ; /.../PHP/41_self_methods/1_instance_41_self_methods/1_instance_41_self_methods.php:1-17
     ; return  [] RANGE[0..0]
...
myclass::F:
     ...
     ; (before optimizer)
     ; /.../PHP/41_self_methods/1_instance_41_self_methods/1_instance_41_self_methods.php:5-7
     ; return  [] RANGE[0..0]
0000 CV0($b) = RECV 1
...
myclass::T:
     ...
     ; (before optimizer)
     ; /.../PHP/41_self_methods/1_instance_41_self_methods/1_instance_41_self_methods.php:9-11
     ; return  [] RANGE[0..0]
0000 CV0($b) = RECV 1
0001 RETURN CV0($b)
0002 RETURN null
